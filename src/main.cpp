...
/** \mainpage RoboComp::socialNavigationGUI
 *
 * \section intro_sec Introduction
 *
 * The socialNavigationGUI component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/socialNavigationGUI --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class socialNavigationGUI : public RoboComp::Application
{
public:
	socialNavigationGUI (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::socialNavigationGUI::initialize()
{
...
int ::socialNavigationGUI::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::socialNavigationGUI app(prefix);
