...
void SpecificWorker::initialize(int period)
{
    ...
    connect(newFreePointButton, SIGNAL(clicked()), this, SLOT(freePoint()));
    ...
    connect(saveToFileButton, SIGNAL(clicked()), this, SLOT(saveToFileB()));

    connect(&timeoutTimer, SIGNAL(timeout()), this, SLOT(timeoutTimerMethod()));
    connect(timeoutPeriod, SIGNAL(valueChanged(double)), this, SLOT(timeoutPeriodChanged(double)));
...
void SpecificWorker::freePoint()
{
    qDebug() << __FUNCTION__;

    QPointF p = navigation.getFreePoints();
